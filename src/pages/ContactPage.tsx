  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content="/galleryy/39_IS33-CB_-_2021.jpg" />
        ...
        <meta property="twitter:image" content="/galleryy/39_IS33-CB_-_2021.jpg" />
        ...
        <div className="flex flex-col lg:flex-row gap-0">
          ...
          <div className="lg:w-[41.67%] flex items-stretch">
            <div 
              ...
              style={{
                backgroundImage: 'url(/galleryy/not-used/1_LPSS-CB_-_2018.jpg)'
              }}
            >
            </div>
          </div>
